...
export const SPECIALTIES: Specialty[] = [
  // ── 내과·진료계열 ──────────────────────────────────────────
  {
    ...
    subspecialties: [
      ...
      { id: 'pulmo', name: '호흡기내과', lens: ['산소요구량 추이(재택산소)', 'PFT(FEV1/FVC/DLCO) 추이', '흉부CT 변화', '흡연력(pack-years)', '최근 악화/입원 빈도', '감염/배양'], blocks: ['진단·중증도(COPD/천식/ILD/폐암)', 'PFT 추이', '영상 추이(결절·섬유화·폐렴)', '산소요구량/재택산소', '악화 빈도', '투약(흡입기·스테로이드·생물학적제제)'], cannotMiss: ['급성 저산소증', '새 폐결절/종괴', '스테로이드 장기 부작용', '반복 급성악화', '폐색전 위험'], chips: ['산소요구량 추이', 'PFT 변화', '영상 신규소견', '악화 이력'] },
  ...
  },
  {
    ...
    // ⚠️ 요약 프롬프트 내용은 docs/research/specialty-needs/OPUS-HANDOFF.md 참조 (Opus 세션 마감).
    // 레지스트리 엔트리·드롭다운에는 존재해야 하므로 안전한 골격만 둠.
    lens: ['최신 정신상태검사(MSE) 소견', '진단명 변화 이력', '향정신성 약물 이력(반응·부작용·순응도)', '정신과 입원/응급실 이력', '물질사용력·사회적 지지체계'],
    blocks: ['최신 MSE', '진단 이력·변화', '약물치료 타임라인(효과·부작용·순응도)', '입원/위기 이력', '정신사회력', '최근 스트레스 요인'],
    cannotMiss: ['정신병적 증상 급성 악화', '약물 관련 응급(리튬 독성·세로토닌 증후군)', '금단 증상 위험'],
    chips: ['약물 타임라인', '입원 이력', 'MSE 변화 추이'],
  },
  {
  ...
  {
    id: 'tuberculosis', name: '결핵과', group: 'internal',
    lens: ['치료 단계·경과일수(집중기/유지기)', '약제감수성(내성·MDR/XDR)', '객담 도말·배양 전환(치료 반응)', '간기능 등 부작용 모니터링(월별)', '흉부영상 추이', '접촉자 조사·전염성'],
    blocks: ['진단·병기(폐/폐외·도말·배양)', '치료 레지멘·시작일·경과', '약제감수성 결과', '객담 전환 추이', '부작용 모니터링(간기능 월별)', '흉부영상 추이·복약 순응도'],
    cannotMiss: ['약제내성(MDR/XDR) 발견', '간독성 징후', '치료 중단/불순응', '2개월 시점 객담 전환 실패'],
    chips: ['치료 경과 요약', '약제감수성 결과', '부작용 모니터링', '영상 추이'],
  },
